---
name: go-lite-noweb
description: Fast workflow without web research or browser testing
disable-model-invocation: true
---

# Go Lite No-Web - Fast Development Workflow

Skips web research and browser testing for speed. Best for straightforward features.

**Model routing**: Opus for strategic phases (plan, review) via Skill tool. Sonnet for execution phases (work, fix) via custom agents / Task tool.
...
8. **Phase 7**: Commit & Push - PR opened? Worktree removed?
